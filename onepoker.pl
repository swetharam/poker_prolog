...
(diamonds,ace)],L3),
		...
		printcards(Sorted_Hand1),
		nl,
		take(Sorted_Hand1,3,M),
		...
		list_sum(List,Sum),
		length(List,X),
		print("Probability with 3 cards:"),
		Prob is Sum/X,
		print(Prob),
		%print(List).
		nl,
		% The following probability is with all 5 cards facing upwards.
		hand_value(Sorted_Hand1,Hvalue1), 
		print("With 5 cards:"),
		nl,
		print("The 5 cards are as follows: "),
		nl,
		print(Sorted_Hand1),
		nl,
		print("Rank of the 5 cards: "),
		print(Hvalue1),
		nl,
		print("Probability with 5 cards : "),
		nl,
