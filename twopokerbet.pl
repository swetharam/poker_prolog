# This program is part of Assignment 4 of Artificial Intelligence course.
# The program is an extension of the twopoker program with additional betting facilities.
...
# initializing the ordering of the card numbers
successor(3,2).
successor(4,3).
successor(5,4).
successor(6,5).
...
# Initializing the relations of order between the different winning hands/patterns in the cards
